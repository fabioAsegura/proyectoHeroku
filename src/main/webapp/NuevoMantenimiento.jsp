        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                ...
                <div class="col-sm-8 text-left"> 
                    ...
                    <hr>
                    <div class="container">   
                        <form class="form-inline" action="mantenimientosCo" method="POST">
                            <div class="form-group">
                                <label for="Idusuario">ID:</label>
                                <input class="form-control" name="id">
                            </div>
                            <div class="form-group">
                                <label for="nombre">ID Activo:</label>
                            ...
                            <div class="form-group">
                                <label for="calificaion">Piezas Cambiadas:</label>
                                <input  class="form-control" name="piezasCambiadas">
                            </div>
                            <br>
                            <div class="span12">&nbsp;</div>
