                    ...
                    <div class="container"> 
                        ...
                        <form class="form-inline" action="EditarAuxiliares" method="POST">
                            <div class="form-group">
                                ...
                                <input  class="form-control" name="id_auxiliar" value="<%=id_auxiliar%>" readonly="readonly">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input  class="form-control" name="turno" value="<%=turno%>">
                            </div>
                            <div class="form-group">
                                <label for="prestaso">ID Supervisor:</label>
                                <input  class="form-control" name="id_supervisor" value="<%=id_supervisor%>">
                            </div>
