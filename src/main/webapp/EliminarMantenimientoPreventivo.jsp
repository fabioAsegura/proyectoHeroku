...
<html lang="en">
    <head>
        <title>Eliminar Mantenimiento Preventivo</title>
        <meta charset="utf-8">
        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                ...
                <div class="col-sm-8 text-left"> 
                    <h1>Eliminar Mantenimiento Preventivo</h1>
                    <p></p>
                    <hr>
                    <div class="container">   
                        <form class="form-inline" action="EliminarMantenimientoPreventivos" method="POST">
